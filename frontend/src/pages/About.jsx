...
function About() {
  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        This is{" "}
        <strong className="text-gray-800 font-semibold hover:scale-105 duration-500">
          {profile?.user?.name}
        </strong>{" "}
        ...
        dynamic, responsive, and user-friendly web applications, Abhay Singh Sengar excels in
      ...
      <br />
      <span>
        Abhay Singh Sengar is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Abhay is a big fan of cricket and
        holds immense admiration for <strong> Captain Cool .</strong> His favorite
        person and biggest inspiration is his twin brother,{" "}
        <strong>Ankush.</strong> Their friendly rivalry and deep bond have
        significantly shaped Abhay’s journey. Ankush is not only a great
        competitor but also a steadfast friend, constantly motivating Abhay to
